...
export class ModificacionesService {
   ...
   */
  async guardarModificacion(data: Omit<ModificacionServicio, 'id'>): Promise<string> {
    try {
  ...
  /**
   * Obtener todas las modificaciones de un pedido específico (como array)
   */
  async obtenerModificacionesPorPedido(pedidoId: string): Promise<ModificacionServicio[]> {
    try {
      const q = query(
   ...
   */
  async obtenerModificacionPorPedido(pedidoId: string): Promise<ModificacionServicio | null> {
    try {
      const q = query(
        collection(db, 'modificacionesServicios'),
        where('pedidoId', '==', pedidoId)
   ...
   */
  async eliminarModificacion(pedidoId: string): Promise<void> {
    try {
